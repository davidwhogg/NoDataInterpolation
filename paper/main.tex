...
% To-Do items
% -----------
% - Change the tone to "here's a method; it is principled and has great properties" and remove all suggestion that it is THE BEST THING. We don't need to win on BEST. We can win on sensible, well justified, good, implemented, demonstrated.
...
Minimum-variance unbiased estimators require care in their construction; they are generally maximum-likelihood estimators (\citealt{something}). % HOGG
...
% Hogg: what do you want to do about this? HOGG SAY: I want to explicitly address it, maybe in a first section after the Introduction. This introduction is too long anyway!
...
HOGG Maybe consider the case of $P\sim\sum_i M_i$. Double descent and all? Or say this earlier in the method section?
