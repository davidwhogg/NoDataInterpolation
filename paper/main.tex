...
% To-Do items
% -----------
% - HOGG check that the code checks out and "just runs".
...
\title{\large \textsl{Frizzle}: Combining spectra or images by forward modeling}
...
We return to this subject below in the Discussion.
