...
The pixel grids were set to slightly under-sample the pixel-convolved LSF, and they were fixed in the rest frame of the spectrograph.
...
The full data set is shown in Figure~\label{fig:data}.
...
HOGG: Choose an interpolator.

HOGG: Interpolate to the $x_\star$ grid and average.

HOGG: Deal with the bad pixels how?

HOGG: Standard practice is way sucky. It is shown in Figure~XX.

\paragraph{Our method HOGG THIS NEEDS A NAME}

We do what we say and show it in Figure~XXX.
