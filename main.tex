...
One is poorly sampled, with $M=171$ spectral pixels in the input data separated by $2/R$ in $x$ (natural logarithm of wavelength), and signal-to-noise per pixel of 17 in the continuum.
...
The two complete data sets are shown in \figurename~\label{fig:data1} and \figurename~\ref{fig:data2}.
\begin{figure}[t!]
...
HOGG: Give full list of input parameters for the Fiducial. NOTE THAT WE DON'T DO THE NOISE IVAR RIGHT.
...
HOGG: HERE SAY WHAT WE FIND RELATIVELY between the Forward Model (tm) and Standard Practice (tm).
